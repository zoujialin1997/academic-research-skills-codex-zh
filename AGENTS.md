...
- 当前版本：Codex 包 `0.4.1`，内嵌 ARS `v3.21.1`
...
### 3. 版本一致性
- `VERSION`、`SKILL.md` 的 `metadata.version`、`manifest.json` 的 `adapter_version`、`plugins/ars-codex-zh/.codex-plugin/plugin.json` 的 `version` 四者必须一致（当前 `0.4.1`）
